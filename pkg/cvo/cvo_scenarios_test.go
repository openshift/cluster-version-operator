	...
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Capabilities: configv1.ClusterVersionCapabilitiesStatus{
				EnabledCapabilities: []configv1.ClusterVersionCapability{configv1.ClusterVersionCapabilityConsole, configv1.ClusterVersionCapabilityInsights, configv1.ClusterVersionCapabilityBaremetal, configv1.ClusterVersionCapabilityMarketplace, configv1.ClusterVersionCapabilityOpenShiftSamples},
				KnownCapabilities:   []configv1.ClusterVersionCapability{configv1.ClusterVersionCapabilityConsole, configv1.ClusterVersionCapabilityInsights, configv1.ClusterVersionCapabilityBaremetal, configv1.ClusterVersionCapabilityMarketplace, configv1.ClusterVersionCapabilityOpenShiftSamples},
			},
			Conditions: []configv1.ClusterOperatorStatusCondition{
				{Type: ImplicitlyEnabledCapabilities, Status: "False", Reason: "AsExpected", Message: "Capabilities match configured spec"},
				{Type: configv1.OperatorAvailable, Status: configv1.ConditionFalse},
...
func TestCVO_InitImplicitlyEnabledCaps(t *testing.T) {
	...
	verifyAllStatus(t, worker.StatusCh(),
		SyncWorkerStatus{
			...
			CapabilitiesStatus: CapabilityStatus{
				...
				ImplicitlyEnabledCaps: []configv1.ClusterVersionCapability{configv1.ClusterVersionCapabilityConsole, configv1.ClusterVersionCapabilityInsights, configv1.ClusterVersionCapabilityMarketplace, configv1.ClusterVersionCapabilityOpenShiftSamples},
			},
			loadPayloadStatus: LoadPayloadStatus{
				Step:               "PayloadLoaded",
				Message:            "Payload loaded version=\"1.0.1-abc\" image=\"image/image:1\"",
	...
	expectUpdateStatus(t, actions[2], "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				{Type: ImplicitlyEnabledCapabilities, Status: configv1.ConditionTrue, Reason: "CapabilitiesImplicitlyEnabled", Message: "The following capabilities could not be disabled: Console, Insights, marketplace, openshift-samples"},
				{Type: DesiredReleaseAccepted, Status: configv1.ConditionTrue, Reason: "PayloadLoaded",
					Message: "Payload loaded version=\"1.0.1-abc\" image=\"image/image:1\""},
				{Type: "Available", Status: "False"},
				{Type: "Failing", Status: "False"},
...
func verifyAllStatusOptionalDone(t *testing.T, ignoreDone bool, ch <-chan SyncWorkerStatus, items ...SyncWorkerStatus) {
	...
	for i, expect := range items {
		...
		//make sure to have a consistent ordering of ImplicitlyEnabledCaps
...
type ByCapability []configv1.ClusterVersionCapability

func (caps ByCapability) Len() int {
	return len(caps)
}

func (caps ByCapability) Swap(i, j int) {
	caps[i], caps[j] = caps[j], caps[i]
}

func (caps ByCapability) Less(i, j int) bool {
