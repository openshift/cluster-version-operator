	...
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				...
				{Type: configv1.OperatorAvailable, Status: configv1.ConditionFalse, Reason: "Unavailable", Message: "No previous Available condition, and have not completely reconciled <unknown>"},
	...
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				...
				{Type: ClusterStatusFailing, Status: "False", Reason: "AsExpected", Message: "All is well."},
				{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "Updating", Message: "Working towards 1.0.0-abc"},
				{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
	...
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				...
				{Type: ClusterStatusFailing, Status: "False", Reason: "AsExpected", Message: "All is well."},
				{Type: configv1.OperatorProgressing, Status: configv1.ConditionFalse, Reason: "Updating", Message: "Cluster version is 1.0.0-abc"},
				{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
				{Type: DesiredReleaseAccepted, Status: configv1.ConditionTrue, Reason: "PayloadLoaded",
					Message: "Payload loaded version=\"1.0.0-abc\" image=\"image/image:1\" architecture=\"" + architecture + "\""},
			},
	...
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				...
				{Type: configv1.OperatorAvailable, Status: configv1.ConditionTrue, Message: "Done applying 1.0.0-abc"},
				{Type: ClusterStatusFailing, Status: "False", Reason: "AsExpected", Message: "All is well."},
				{Type: configv1.OperatorProgressing, Status: configv1.ConditionFalse, Reason: "ReconcilingCompletedRelease", Message: "Cluster version is 1.0.0-abc"},
				{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
				{Type: DesiredReleaseAccepted, Status: configv1.ConditionTrue, Reason: "PayloadLoaded",
					Message: "Payload loaded version=\"1.0.0-abc\" image=\"image/image:1\" architecture=\"" + architecture + "\""},
			},
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				...
				{Type: DesiredReleaseAccepted, Status: configv1.ConditionFalse, Reason: "RetrievePayload",
					Message: "Retrieving payload failed version=\"1.0.1-abc\" image=\"image/image:1\" failure=The update cannot be verified: some random error"},
				{Type: configv1.OperatorAvailable, Status: "False", Reason: "Unavailable", Message: "No previous Available condition, and have not completely reconciled 1.0.1-abc"},
				{Type: ClusterStatusFailing, Status: "False", Reason: "AsExpected", Message: "All is well."},
				{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "Updating", Message: "Working towards 1.0.1-abc"},
				{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
			},
		},
	})
	...
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				...
				{Type: ClusterStatusFailing, Status: "False", Reason: "AsExpected", Message: "All is well."},
				{Type: configv1.OperatorProgressing, Status: configv1.ConditionFalse, Reason: "ReconcilingCompletedRelease", Message: "Cluster version is 1.0.1-abc"},
				{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
			},
		},
	})
	...
	expectUpdateStatus(t, actions[3], "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				...
				{Type: DesiredReleaseAccepted, Status: configv1.ConditionTrue, Reason: "PayloadLoaded",
					Message: "Payload loaded version=\"1.0.0-abc\" image=\"image/image:0\""},
				{Type: configv1.OperatorAvailable, Status: "False", Reason: "Unavailable", Message: "No previous Available condition, and have not completely reconciled 1.0.0-abc"},
				{Type: ClusterStatusFailing, Status: "False", Reason: "AsExpected", Message: "All is well."},
				{Type: configv1.OperatorProgressing, Status: "False", Message: "Cluster version is 1.0.0-abc"},
				{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
			},
		},
	})
...
func TestCVO_InitImplicitlyEnabledCaps(t *testing.T) {
	...
	expectFinalUpdateStatus(t, actions, "clusterversions", "", &configv1.ClusterVersion{
		...
		Status: configv1.ClusterVersionStatus{
			...
			Conditions: []configv1.ClusterOperatorStatusCondition{
				{Type: ImplicitlyEnabledCapabilities, Status: configv1.ConditionTrue, Reason: "CapabilitiesImplicitlyEnabled", Message: "The following capabilities could not be disabled: CSISnapshot, Console, Insights, Storage, marketplace, openshift-samples"},
				{Type: DesiredReleaseAccepted, Status: configv1.ConditionTrue, Reason: "PayloadLoaded",
					Message: "Payload loaded version=\"1.0.1-abc\" image=\"image/image:1\" architecture=\"" + architecture + "\""},
				{Type: configv1.OperatorAvailable, Status: "False", Reason: "Unavailable", Message: "No previous Available condition, and have not completely reconciled 1.0.1-abc"},
				{Type: ClusterStatusFailing, Status: "False", Reason: "AsExpected", Message: "All is well."},
