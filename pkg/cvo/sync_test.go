...
func (r *fakeSyncRecorder) Update(generation int64, desired configv1.Update, overrides []configv1.ComponentOverride, state payload.State, config *configv1.ClusterVersion) *SyncWorkerStatus {
