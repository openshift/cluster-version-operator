					...
					&configv1.ClusterVersion{
						...
						Status: configv1.ClusterVersionStatus{
							...
							Conditions: []configv1.ClusterOperatorStatusCondition{
								...
								{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "Updating", Message: "Working towards 4.0.1"},
				...
				expectUpdateStatus(t, act[1], "clusterversions", "", &configv1.ClusterVersion{
					...
					Status: configv1.ClusterVersionStatus{
						...
						Conditions: []configv1.ClusterOperatorStatusCondition{
							{Type: ImplicitlyEnabledCapabilities, Status: "False", Reason: "AsExpected", Message: "Capabilities match configured spec"},
							{Type: configv1.OperatorAvailable, Status: configv1.ConditionFalse},
							{Type: ClusterStatusFailing, Status: configv1.ConditionTrue, Reason: "UnknownError", Message: "injected error"},
							{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "UnknownError", Message: "Unable to apply 0.0.1-abc: an error occurred"},
							{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
						},
					},
				})
				...
				expectUpdateStatus(t, act[1], "clusterversions", "", &configv1.ClusterVersion{
					...
					Status: configv1.ClusterVersionStatus{
						...
						Conditions: []configv1.ClusterOperatorStatusCondition{
							{Type: ImplicitlyEnabledCapabilities, Status: "False", Reason: "AsExpected", Message: "Capabilities match configured spec"},
							{Type: configv1.OperatorAvailable, Status: configv1.ConditionFalse},
							{Type: ClusterStatusFailing, Status: configv1.ConditionTrue, Reason: "UnknownError", Message: "file does not exist"},
							{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "UnknownError", Message: "Unable to apply 4.0.1: an error occurred"},
							{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
						},
					},
				})
				...
				expectUpdateStatus(t, act[1], "clusterversions", "", &configv1.ClusterVersion{
					...
					Status: configv1.ClusterVersionStatus{
						...
						Conditions: []configv1.ClusterOperatorStatusCondition{
							...
							{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "Updating", Message: "Working towards image/image:v4.0.1"},
							{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
						},
					},
				})
				...
				expectUpdateStatus(t, act[1], "clusterversions", "", &configv1.ClusterVersion{
					...
					Status: configv1.ClusterVersionStatus{
						...
						Conditions: []configv1.ClusterOperatorStatusCondition{
							...
							{Type: configv1.OperatorAvailable, Status: configv1.ConditionFalse},
							{Type: ClusterStatusFailing, Status: configv1.ConditionFalse},
							{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "Updating", Message: "Working towards 4.0.2"},
							{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
						},
					},
				})
				...
				expectUpdateStatus(t, act[1], "clusterversions", "", &configv1.ClusterVersion{
					...
					Status: configv1.ClusterVersionStatus{
						...
						Conditions: []configv1.ClusterOperatorStatusCondition{
							...
							{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "Updating", Message: "Working towards 4.0.1: 334 of 1000 done (33% complete)"},
							{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
						},
					},
				})
				...
				expectUpdateStatus(t, act[1], "clusterversions", "", &configv1.ClusterVersion{
					...
					Status: configv1.ClusterVersionStatus{
						...
						Conditions: []configv1.ClusterOperatorStatusCondition{
							...
							{Type: configv1.OperatorAvailable, Status: configv1.ConditionFalse},
							{Type: ClusterStatusFailing, Status: configv1.ConditionFalse},
							{Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "Updating", Message: "Working towards 0.0.1-abc"},
							{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
						},
					},
				})
					...
					&configv1.ClusterVersion{
						...
						Status: configv1.ClusterVersionStatus{
							...
							Conditions: []configv1.ClusterOperatorStatusCondition{
								...
								{Type: configv1.OperatorAvailable, Status: configv1.ConditionTrue, Message: "Done applying 0.0.1-abc"},
								{Type: ClusterStatusFailing, Status: configv1.ConditionFalse},
								{Type: configv1.OperatorProgressing, Status: configv1.ConditionFalse, Reason: "ReconcilingCompletedRelease", Message: "Cluster version is 0.0.1-abc"},
								{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
							},
						},
					},
				...
				expectUpdateStatus(t, act[1], "clusterversions", "", &configv1.ClusterVersion{
					...
					Status: configv1.ClusterVersionStatus{
						...
						Conditions: []configv1.ClusterOperatorStatusCondition{
							...
							{Type: ClusterStatusFailing, Status: configv1.ConditionFalse},
							{Type: configv1.OperatorProgressing, Status: configv1.ConditionFalse, Reason: "ReconcilingCompletedRelease", Message: "Cluster version is 4.0.1"},
							{Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse},
						},
					},
				})
