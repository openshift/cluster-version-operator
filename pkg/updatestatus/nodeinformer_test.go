	...
	testCases := []struct {
				...
				Conditions: []metav1.Condition{
					{
						...
						Reason:             "Pending",
						Message:            "The update of the node <node> is pending",
					},
					{
						Type:    "Available",
						Status:  "False",
					...
					},
					{
						...
						Status:             "False",
						Reason:             "AsExpected",
						Message:            "The node <node> is not degraded",
						LastTransitionTime: now,
					},
				},
			},
			...
			expected: &NodeStatusInsight{
				...
				Conditions: []metav1.Condition{
					...
					},
					{
						...
						Status:             "True",
						Reason:             "AsExpected",
						Message:            "The node <node> is available",
						LastTransitionTime: now,
					},
					{
						Type:               "Degraded",
		...
		},
		{
			...
			expected: &NodeStatusInsight{
				...
				Message:       "The update of the node <node> is paused",
				Conditions: []metav1.Condition{
					{
						Type:               "Updating",
						Status:             "False",
		...
		},
		{
			...
			expected: &NodeStatusInsight{
				...
				Scope:         "WorkerPool",
				Version:       "4.1.23",
				Message:       "The node <node> is updated",
				EstToComplete: toPointer(time.Duration(0)),
				Conditions: []metav1.Condition{
					{
						Type:               "Updating",
		...
		},
		{
			...
			expected: &NodeStatusInsight{
				...
				Message:       "The node <node> is updating",
				Conditions: []metav1.Condition{
					{
						Type:               "Updating",
						Status:             "True",
		...
		},
		{
			...
			expected: &NodeStatusInsight{
				...
				Version:       "4.1.23",
				EstToComplete: toPointer(10 * time.Minute),
				Message:       "The node <node> is draining",
				Conditions: []metav1.Condition{
					{
						Type:               "Updating",
						Status:             "True",
		...
		},
		{
			...
			expected: &NodeStatusInsight{
				...
				Version:       "4.1.23",
				EstToComplete: toPointer(10 * time.Minute),
				Message:       "The node <node> is rebooting",
				Conditions: []metav1.Condition{
					{
						Type:               "Updating",
						Status:             "True",
		...
		},
		{
			...
			expected: &NodeStatusInsight{
				...
				Scope:   "WorkerPool",
				Message: "Node <node> is not ready",
				Conditions: []metav1.Condition{
					{
						Type:               "Updating",
						Status:             "False",
				...
				"node-worker-1": {
					...
					WorkerPoolInsightUnion: WorkerPoolInsightUnion{
						...
						NodeStatusInsight: &NodeStatusInsight{
							...
							Message:  "The update of the node <node> is pending",
							Conditions: []metav1.Condition{
								{Type: "Updating", Status: "False", LastTransitionTime: now, Reason: "Pending", Message: "The update of the node <node> is pending"},
								{Type: "Available", Status: "True", LastTransitionTime: now, Reason: "AsExpected", Message: "The node <node> is available"},
								{Type: "Degraded", Status: "False", LastTransitionTime: now, Reason: "AsExpected", Message: "The node <node> is not degraded"},
							},
						},
					},
				},
				...
				"node-worker-1": {
					...
					WorkerPoolInsightUnion: WorkerPoolInsightUnion{
						...
						NodeStatusInsight: &NodeStatusInsight{
							...
							Message:       "The node <node> is updating",
							Conditions: []metav1.Condition{
								{Type: "Updating", Status: "True", LastTransitionTime: now, Reason: "Updating", Message: "The node <node> is updating"},
								{Type: "Available", Status: "True", LastTransitionTime: now, Reason: "AsExpected", Message: "The node <node> is available"},
								{Type: "Degraded", Status: "False", LastTransitionTime: now, Reason: "AsExpected", Message: "The node <node> is not degraded"},
							},
						},
