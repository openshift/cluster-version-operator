...
require (
	...
	github.com/openshift/origin v1.5.0-alpha.3.0.20251003005810-3ded19edb985
...
replace (
	...
	k8s.io/legacy-cloud-providers => github.com/openshift/kubernetes/staging/src/k8s.io/legacy-cloud-providers v0.0.0-20250716113245-b94367cabf3e
