...
// MachineConfigPoolStatusInsightApplyConfiguration represents an declarative configuration of the MachineConfigPoolStatusInsight type for use
// with apply.
type MachineConfigPoolStatusInsightApplyConfiguration struct {
	...
	Scope      *configv1alpha1.ScopeType                  `json:"scopeType,omitempty"`
	Assessment *configv1alpha1.PoolUpdateAssessment       `json:"assessment,omitempty"`
	Completion *int32                                     `json:"completion,omitempty"`
	Summaries  []PoolNodesUpdateSummaryApplyConfiguration `json:"summaries,omitempty"`
	Conditions []v1.ConditionApplyConfiguration           `json:"conditions,omitempty"`
}

// MachineConfigPoolStatusInsightApplyConfiguration constructs an declarative configuration of the MachineConfigPoolStatusInsight type for use with
// apply.
...
func (b *MachineConfigPoolStatusInsightApplyConfiguration) WithResource(value *ResourceRefApplyConfiguration) *MachineConfigPoolStatusInsightApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *MachineConfigPoolStatusInsightApplyConfiguration) WithScope(value configv1alpha1.ScopeType) *MachineConfigPoolStatusInsightApplyConfiguration {
	b.Scope = &value
	return b
}
...
func (b *MachineConfigPoolStatusInsightApplyConfiguration) WithAssessment(value configv1alpha1.PoolUpdateAssessment) *MachineConfigPoolStatusInsightApplyConfiguration {
	b.Assessment = &value
	return b
}
...
func (b *MachineConfigPoolStatusInsightApplyConfiguration) WithSummaries(values ...*PoolNodesUpdateSummaryApplyConfiguration) *MachineConfigPoolStatusInsightApplyConfiguration {
	for i := range values {
		if values[i] == nil {
