...
// UpdateStatusApplyConfiguration represents an declarative configuration of the UpdateStatus type for use
// with apply.
type UpdateStatusApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *v1alpha1.UpdateStatusSpec            `json:"spec,omitempty"`
	Status                           *UpdateStatusStatusApplyConfiguration `json:"status,omitempty"`
}

// UpdateStatus constructs an declarative configuration of the UpdateStatus type for use with
// apply.
...
// Experimental!
func ExtractUpdateStatus(updateStatus *v1alpha1.UpdateStatus, fieldManager string) (*UpdateStatusApplyConfiguration, error) {
...
// Experimental!
func ExtractUpdateStatusStatus(updateStatus *v1alpha1.UpdateStatus, fieldManager string) (*UpdateStatusApplyConfiguration, error) {
	return extractUpdateStatus(updateStatus, fieldManager, "status")
}

func extractUpdateStatus(updateStatus *v1alpha1.UpdateStatus, fieldManager string, subresource string) (*UpdateStatusApplyConfiguration, error) {
	b := &UpdateStatusApplyConfiguration{}
...
func (b *UpdateStatusApplyConfiguration) WithSpec(value v1alpha1.UpdateStatusSpec) *UpdateStatusApplyConfiguration {
	b.Spec = &value
	return b
}
