...
func (in *ControlPlaneUpdateStatus) DeepCopyInto(out *ControlPlaneUpdateStatus) {
	*out = *in
	in.ControlPlaneUpdateStatusSummary.DeepCopyInto(&out.ControlPlaneUpdateStatusSummary)
	if in.Informers != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ControlPlaneUpdateStatusSummary) DeepCopyInto(out *ControlPlaneUpdateStatusSummary) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControlPlaneUpdateStatusSummary.
func (in *ControlPlaneUpdateStatusSummary) DeepCopy() *ControlPlaneUpdateStatusSummary {
	if in == nil {
		return nil
	}
	out := new(ControlPlaneUpdateStatusSummary)
	in.DeepCopyInto(out)
	return out
}
