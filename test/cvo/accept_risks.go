...
var _ = g.Describe(`[Jira:"Cluster Version Operator"] cluster-version-operator`, func() {
	...
	// Serial may not be essential here as it does not modify CV.
	// However, there is no compliance job with TP enabled, and the
	// alert we create in the test might be noise for other cases.
